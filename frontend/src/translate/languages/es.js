  ...
  es: {
    translations: {
      ...
      ticketsList: {
        ...
        noQueue: "Sin Cola",
        metaReplyWindow:
          "Tienes 24 horas para responder después de recibir un mensaje, de acuerdo con las políticas de Meta.",
        buttons: {
          accept: "Aceptar",
          cancel: "Cancelar",
          start: "Iniciar",
